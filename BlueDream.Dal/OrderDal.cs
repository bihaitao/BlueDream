...
namespace BlueDream.Dal
{
    public class OrderDal
    {
        ...
        /// <returns></returns>
        public static List<OrderEntity> GetListByPage(DBClient p_DBClient, int p_PageSize, int p_PageIndex, string p_SearchKey, ref int p_TotalCount)
        {
            return p_DBClient.Instance.Queryable<OrderEntity>()
              .Where(t => t.DataState == DataStateEnum.Valid)
              .WhereIF((p_SearchKey != "*"), t => t.CustomerOrderNo.Contains(p_SearchKey))
        ...
        /// <returns></returns>
        public static List<OrderModel> GetListModelByPage(DBClient p_DBClient, int p_PageSize, int p_PageIndex, string p_SearchKey, ref int p_TotalCount)
        {
